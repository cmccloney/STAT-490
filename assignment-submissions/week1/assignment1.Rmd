...
par(mfrow=c(1,2))
plot(as.numeric(as.character(average_rating))~as.numeric(ratings_count),data=books_data, ylab="Average Rating", xlab="Number of Ratings")
plot(as.numeric(as.character(average_rating))~as.numeric(text_reviews_count),data=books_data, ylab="Average Rating", xlab="Number of Text Reviews")
par(mfrow=c(1,2))
plot(as.numeric(as.character(average_rating))~as.numeric(X..num_pages),data=books_data, ylab="Average Rating", xlab="Number of Pages")
plot(as.numeric(as.character(average_rating))~language_code,data=books_data, ylab="Average Rating", xlab="Language Code")
```
...
boxplot(Standard.deviation.of.the.DM.SNR.curve~target_class,data=pulsar_data, ylab="SD of DM-SNR curve", xlab="Target Reading")
par(mfrow=c(1,2))
